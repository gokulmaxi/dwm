...
static const char *altbarcmd =
    "$HOME/launch.sh"; /* Alternate bar launch command */
...
const char *spcmd2[] = {"st",     "-n", "spcalc", "-g",
                        "144x41", "-e", "insect", NULL};
const char *spcmd3[] = {"st",     "-n", "spmusic", "-g",
...
static const char *const autostart[] = {
    ...
    "compton", NULL, "fehbg", NULL, "batsignal", NULL, NULL /* terminate */
};
...
{ MODKEY,                       XK_s,      spawndefault,   {0} },
    ...
    {MODKEY,XK_v,spawn,{.v=cmd_skippy}},
